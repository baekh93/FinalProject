...
<body>
	<!-- Navigation -->
	<%@ include file="inc/topbar.jsp"%><br>
	<br>
	<br>
	<center>
...
'정보통신망 이용촉진 및 정보보호 등에 관한 법률'의 거래기록 보존 의무에 따른 보존: 1년
		...
		<br>
		<!-- 		<br> <a href="#"> -->
		<!-- 			<button type="button" class="btn_order" style="margin: 10px;">회 -->
		<!-- 				원 가 입</button> -->
		<!-- 		</a> <a href="#"> -->
		<!-- 			<button type="button" class="btn_cancel1" style="margin: 10px;">취 -->
		<!-- 				소 하 기</button> -->
		<!-- 		</a> -->
